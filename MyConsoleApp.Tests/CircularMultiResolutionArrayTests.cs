...
//        {
//            Assert.AreEqual(3 - i, arr[arr.GetIndex((int)i)], 1e-6, $"Index {i}");
//        }
//    }
...
//        {
//            Assert.AreEqual(7 - i, arr[arr.GetIndex((int)i)], 1e-3, $"Index {i}");
//        }
//        Assert.IsTrue(Math.Abs(arr[arr.GetIndex((int)(arr.Count - 1))] - 0f) < 0.5f);
//    }
...
//        {
//            Assert.AreEqual(4 - i, arr[arr.GetIndex((int)i)], 1e-5, $"Index {i}");
//        }
//        Assert.IsTrue(Math.Abs(arr[arr.GetIndex((int)(arr.Count - 1))] - 0f) < 0.5f);
//    }
